    ...
    return (
        <div className="fixed p-2 bg-white rounded shadow-md flex bottom-0 drop-shadow-lg w-screen left-0 flex justify-center">
            ...
            <Link href="/trip" passHref>
                <div className="flex flex-col items-center justify-center group">
                    <svg className={`group-hover:fill-current group-hover:text-primary-600 ${isActiveSvg('/trip')}`} width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
